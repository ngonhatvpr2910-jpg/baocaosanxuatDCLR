...
export default function App() {
  ...
  return (
    ...
    <DashboardTab
      ...
      scrapMonthRange={scrapMonthRange}
      setScrapMonthRange={setScrapMonthRange}
      scrapWeekRange={scrapWeekRange}
      setScrapWeekRange={setScrapWeekRange}
      past4WeeksList={past4WeeksList}
      comparison3MonthsData={comparison3MonthsData}
      comparison4WeeksData={comparison4WeeksData}
